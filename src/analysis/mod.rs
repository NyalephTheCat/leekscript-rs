...
pub use node_helpers::{
    ...
    class_member_visibility, function_decl_info, member_expr_member_name, member_expr_receiver_name,
    param_name, primary_expr_resolvable_name, var_decl_info, ClassDeclInfo, FunctionDeclInfo,
    VarDeclInfo, VarDeclKind,
};
pub use scope::{
    MemberVisibility, ResolvedSymbol, Scope, ScopeId, ScopeKind, ScopeStore, VariableInfo,
    VariableKind,
};
...
pub struct AnalyzeOptions<'a> {
    ...
    pub include_tree: Option<&'a crate::preprocess::IncludeTree>,
...
pub fn analyze_with_include_tree(
    tree: &crate::preprocess::IncludeTree,
...
pub fn analyze_with_signatures(
    ...
    let (diagnostics, type_map) =
        run_pipeline(program_root, &builder.store, &builder.scope_id_sequence, &options);
